...
export class RandomStaffBrosTeams extends RandomTeams {
	randomStaffBrosTeam(options: {inBattle?: boolean} = {}) {
		...
		const debug: string[] = ['QuantumTangler', 'gigigecko26', 'TacocaT_2595', 'VolticHalberd', 'RibbonNymph']; // Set this to a list of SSB sets to override the normal pool for debugging.
