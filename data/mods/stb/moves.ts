	...
	*/
	...
	pharaohscurse: {
		...
		onTryHit(target, source, move) {
			if (move.volatileStatus && (target.volatiles['curse'] || target.volatiles['pharaohscurse'] ||
	...
	curse: {
		...
		onTryHit(target, source, move) {
			...
			} else if (move.volatileStatus && (target.volatiles['curse'] || target.volatiles['pharaohscurse'] ||
					target.volatiles['haunting'])) {
				return false;
			}
		},
