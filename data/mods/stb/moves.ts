...
export const Moves: {[k: string]: ModdedMoveData} = {
	...
	*/
	...
	stareater: {
		...
		basePower: 50,
		category: "Physical",
		desc: "Restores HP equal to the average of the target's Atk and SpAtk stats, and lowers whichever one is higher by one stage. Additionally, if this move runs out of pp the user does damage to the opponent equal to the user's current HP.",
		shortDesc: "Heals by target's (Atk+SpA)/2, -1 to opponent's higher stat. Final gambit on final usage.",
		name: "Star Eater",
		gen: 8,
